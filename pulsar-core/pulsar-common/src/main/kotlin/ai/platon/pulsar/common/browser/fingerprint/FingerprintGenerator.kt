...
interface FingerprintGenerator {
    ...
    fun generate(
        ...
        preset: BasicFingerprintGenerator.DevicePreset = BasicFingerprintGenerator.DevicePreset.DESKTOP_WINDOWS
    ): Fingerprint
    ...
    fun generateRandom(
        browserType: BrowserType,
        platform: BasicFingerprintGenerator.Platform = BasicFingerprintGenerator.Platform.WINDOWS
    ): Fingerprint
}
