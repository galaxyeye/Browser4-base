...
import ai.platon.pulsar.common.browser.fingerprint.BasicFingerprintGenerator.DevicePreset
import ai.platon.pulsar.common.browser.fingerprint.BasicFingerprintGenerator.Platform
 ...
 *
 * This class implements [FingerprintGenerator] and serves as the built-in
 ...
 */
class ProfessionalFingerprintGenerator : FingerprintGenerator {
    ...
    private fun generateUserAgent(
        ...
        val chromeVersion = BasicFingerprintGenerator.DEFAULT_CHROME_VERSION
