...
class MCPToolControllerTest {
    ...
    fun `test generic commands`() = runBlocking {
        val commands = listOf(
            ...
            "press" to "driver",
            "hover" to "driver",
            "screenshot" to "driver",
            "dblclick" to "driver",
            "drag" to "driver",
            "select_option" to "driver",
            "upload" to "driver",
            "check" to "driver",
            "uncheck" to "driver",
            "type" to "driver",
            "evaluate" to "driver",
            "dialog_accept" to "driver",
            "dialog_dismiss" to "driver",
            "resize" to "driver",
            "keydown" to "driver",
            "keyup" to "driver",
            "mousemove" to "driver",
            "mousedown" to "driver",
            "mouseup" to "driver",
            "mousewheel" to "driver"
        )

        for ((tool, domain) in commands) {
            mockTool(domain, tool)
            ...
            mockTool(domain, tool) // Re-apply stubbing
            ...
            assertEquals(tool, toolCall.method)
        }
    }
