...
# =============================================================================
# This script reads use case files from pulsar-tests/pulsar-tests-common/src/main/resources/e2e/scenarios/adversarial/use-cases/
...
readonly USE_CASES_DIR="$AppHome/pulsar-tests/pulsar-tests-common/src/main/resources/e2e/scenarios/adversarial/use-cases"
...
USE CASE FILES:
    Use case files are located in: pulsar-tests/pulsar-tests-common/src/main/resources/e2e/scenarios/adversarial/use-cases/
