...
/*
 * This file contains the definitions of all available CLI commands.
 * Each command includes its name, description, category, arguments, options,
 * and the corresponding tool name and parameters to be invoked.
 */
...
const numberArg = z.preprocess((val, ctx) => {
    // Preprocesses input values to coerce them into numbers, reporting an error if invalid.
